...
ALTER TABLE PAGO ADD CONSTRAINT FK_PAGO_TIPO FOREIGN KEY (TIPO_PAGO) REFERENCES TIPO_PAGO (ID_TIPO) ON DELETE CASCADE;
ALTER TABLE PAGO ADD CONSTRAINT FK_PAGO_TIPO FOREIGN KEY (TIPO_PAGO) REFERENCES TIPO_PAGO (ID_TIPO) ON DELETE CASCADE;
...
BEGIN 
	IF VERIFICAR_CLIENTE(CLIENTE_B)= TRUE THEN 
		IF VERIFICAR_BOLETA(ID_B)= FALSE THEN
			...
			INSERT INTO BOLETA VALUES (ID_B,CLIENTE_B,FECHA_B,HORA_B,TOTAL_B);
			COMMIT;
		ELSE
			RAISE BOLETA_EXISTE;
		END IF;
